...
func GetStringMpa(key string) map[string]interface{} {
	return cast.ToStringMap(Get(key))
}

func GetStringMpaString(key string) map[string]string {
	return cast.ToStringMapString(Get(key))
}

func GetStringMpaStringSlice(key string) map[string][]string {
